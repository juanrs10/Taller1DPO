...
public class ConsolaOlimpicos
{
	...
	/**
	 * Le muestra al usuario el pais de un atleta determinado 
	 */
	private void ejecutarPaisAtleta()
	{
		System.out.println("\n" + "Pais que representa el atleta" + "\n");

		String atletaName = input("Por favor ingrese el nombre del atleta");

		Atleta response = calculadora.buscarAtleta(atletaName);
		
		System.out.println(response.darPais());
	}
